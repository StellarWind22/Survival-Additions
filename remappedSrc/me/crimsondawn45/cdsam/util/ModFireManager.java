...
public class ModFireManager {
	...
	public static void init() {
		...
		//Modded
		setFireInfo(ModBlocks.scrap_planks.getBlock(), FT.PLANKS);
		setFireInfo(ModBlocks.scrap_stairs.getBlock(), FT.PLANKS);
		setFireInfo(ModBlocks.scrap_slab.getBlock(), FT.PLANKS);
	...
	public static void setFireInfo(Block block, FT FT)
	{
		try
		{
			Method method = FireBlock.class.getMethod("registerFlammableBlock", Block.class, Integer.class);
			
			method.setAccessible(true);
			
			switch(FT)
			{
			case LOG:			method.invoke(block, 5, 5);		break;
			case WORKSTATION:	method.invoke(block, 5, 10);	break;
			case CLOTH:			method.invoke(block, 30, 60);	break;
			case PLANKS:		method.invoke(block, 5, 20);	break;
			case PLANT:			method.invoke(block, 60, 100);	break;
